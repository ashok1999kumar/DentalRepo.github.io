...
<section class="container-fluid">
  <div class="row">
  <div class="col-sm-12 col-md-8 col-lg-8 pt-4 mobile-nav col-11">
    <!-- column started -->
    <div>
      <!-- logo -->
      <img src="images/header-image/MainLogo.png" class="
      img-fluid px-5 mainLogo">
    </div>
  </div>
  <!-- end column -->
  <div class="col-sm-4 col-md-4 col-lg-4 pt-5 col-1 rem float-right">
    <!-- started column -->
    <span class="tripple-icon justify-content-end mobile-nav-icon" style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776;</span>
    <div class="d-flex justify-content-end justify-md-content-center">
      <li class="nav-item dropdown d-flex ">
        <button class="book-appoinment btn-info px-3 mx-2 text-light fw-bold">book an appoinment</button>
        <button class="login px-3 py-2 mx-1 text-light fw-bold nav-link dropdown-toggle btn-secondary" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false"><span>login</span><img src="images/header-image/layer_163.png" class="px-2"></button>
